<template>
	<div class="h-screen md:flex">
		<div
			class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-sky-900 to-purple-800 i justify-around items-center hidden">
			<div>
				<div>
			...
			<form class="bg-white">
				...
				<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					...
					<div class="flex items-center border-2 py-2 px-3 rounded-2xl">
						...
						<Link as="button"  type="submit" class="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Registrar</Link>
